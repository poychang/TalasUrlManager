...
@NgModule({
  ...
  exports: [HeaderComponent, ShortenInputSectionComponent, ShortenListSectionComponent],
  declarations: [HeaderComponent, ShortenInputSectionComponent, ShortenListSectionComponent]
})
